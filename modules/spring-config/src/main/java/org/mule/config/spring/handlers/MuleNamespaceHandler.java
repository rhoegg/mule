...
import org.mule.config.spring.factories.CustomMergeStrategyFactoryBean;
...
public class MuleNamespaceHandler extends AbstractMuleNamespaceHandler
{
    ...
    public void init()
    {
        ...
        registerBeanDefinitionParser("custom-merge-strategy", new ChildDefinitionParser("eventMergeStrategy", CustomMergeStrategyFactoryBean.class));
